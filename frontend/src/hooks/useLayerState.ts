...
export const INITIAL_LAYERS: LayerConfig[] = [
  { id: 'auto-plants', name: 'Automobile Assembly Plants', visible: true, opacity: 0.9, colorHex: '#F59E0B', zIndex: 2, legendVisible: false },
  { id: 'power-grid', name: 'Transmission Lines', visible: true, opacity: 0.8, colorHex: '#06B6D4', zIndex: 1, legendVisible: true },
  { id: 'power-plants', name: 'Power Plants', visible: true, opacity: 0.9, colorHex: '#22C55E', zIndex: 3, legendVisible: true },
  { id: 'industrial-convergence', name: 'Industrial Convergence Facilities', visible: true, opacity: 0.9, colorHex: '#A855F7', zIndex: 4, legendVisible: false },
];
